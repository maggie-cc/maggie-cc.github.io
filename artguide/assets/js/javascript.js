...
var page2 = {
    ...
    body2:"<b>Known Artists:</b><br> Henri Matisse, Georges Roualt, André Derain, and Maurice de Vlaminck.<br><b>Subject Matter:</b> <br>Images of contemporary life (influence of Impressionism).<br><b>Style:</b><br>Violently contrasting, non descriptive colors, and flat patterns.", 
    caption:"Henri Matisse, <i>The Red Room</i>, 1908,<br>Oil on canvas,<br>180 cm × 220 cm (70.9 in × 86.6 in),<br>Hermitage Museum, St. Petersburg",
    image: "02.jpg"
}; 
...
var page3 = {
    ...
    body2:"<b>Known artists:</b><br>Emil Nolde, Edvard Munch, Egon Schiele, Paul Klee, Wassily Kandinsky<br><b>Subject Matter:</b><br>The unconscious mind, sexuality, the meaning of dreams and internal struggles of repression and anxiety.<br><b>Style:</b><br>Flat, linear, rhythmical expression; simplification of form; not objective reality but rather the subjective emotions and responses that objects and events arouse within a person.", 
    //insert breaks
    caption: "Egon Schiele, <i>Self-Portrait with Chinese Lantern Plant</i>, 1912,<br>Oil and opaque color on wood,<br>w398 x h322 cm (Without Frame),<br>Leopold Museum, Vienna, Austria",
    image: "03.jpg"
}; 
...
var page4 = {
    ...
    //Need to insert breaks before Subject Matter and Style, as well as bold Known Artists, Subject Matter and Style
    body2: "<b>Who:</b><br>Pablo Picasso, Georges Braque, Juan Gris, and Raymond Duchamp-Villon.<br><b>Subject Matter:</b><br>Portraits, figure studies, still lifes, landscapes.<br><b>Style:</b><br>Analytic Cubism: dull, muddy, facets of color. Objects and background treated with similar concern. Synthetic Cubism: collage look, stencils, actual materials, usually vibrant color.",
    //insert breaks
    caption: "Pablo Picasso, <i>Still Life with Chair Caning</i>, 1912,<br>Oil on oil-cloth over canvas edged with rope,<br>29 x 37 cm<br>Musée Picasso, Paris",
    image: "09.jpg"
}; 
...
var page5 = {
    ...
    //Need to insert breaks before Subject Matter and Style, as well as bold Known Artists, Subject Matter and Style
    body2:"<b>Who:</b><br>Filippo Tommaso Marinetti, Giacomo Balla, Umberto Boccioni, Carlo Carrà, and Gino Severini.<br><b>Subject Matter:</b><br>Figures and objects in motion. Said Marinetti: 'A roaring motorcar...is more beautiful than the Victory of Samothrace.'<br><b>Style:</b><br>Visual embodiment of dynamism. Speed represented by the merging of objects or figures with their backgrounds. Vivid colors.",
    //insert breaks
    caption:"Umberto Boccioni, <i>Unique Forms of Continuity in Space</i>, 1913,<br>Plaster,<br>3′ 8″ x 2′ 11″,<br>Museum of Contemporary Art, University of São Paulo",
    image: "13.jpg"
}; 
...
var page6 = {
    ...
    //Need to insert breaks before Subject Matter and Style, as well as bold Known Artists, Subject Matter and Style
    body2: "<b>Who:</b><br>Lyonel Feininger, Alexey von Jawlensky, Wassily Kandinsky, Paul Klee, and Franz Marc.<br><b>Subject Matter:</b><br>Portraits, landscapes, and animals, as well as non-objective scenes.<br><b>Style:</b><br>Extremely varied among the members: vibrant color, representational, abstract, and non-objective.",
    //insert breaks
    caption: "Franz Marc, <i>Zwei grosse Pferde in Landschaft (Two large horses in a landscape)</i>, ca. 1912,<br>Oil and mixed media on glass,<br>20.3 x 31.2 cm. (8 x 12.3 in.)",
    image: "08.jpg"
}
...
var page7 = {
    ...
    //Need to insert breaks before Subject Matter and Style, as well as bold Known Artists, Subject Matter and Style
    body2:"<b>Who:</b><br>Vladimir Tatlin, Naum Gabo, El Lissitzky, Antoine Pevsner, Liubov Popova, and Alexander Rodchenko.<br><b>Subject Matter:</b><br>Some works are non-representational, while others are functional.<br><b>Style:</b><br>Abstract assemblages of industrial metal, plastic, glass, and wire. Among the first total abstractions in the history of sculpture. Other constructions were prototypes for architectural, stage, or industrial designs.",
    //insert breaks
    caption:"Vladimir Tatlin,<i>Painterly Relief</i>, 1914-1916,<br>Wood, metal, and leather,<br>24 2/5 × 20 9/10 in,<br>Fondation Beyeler, Riehen",
    image: "14.jpg"
}; 
...
var page8 = {
    ...
    //Need to insert breaks before Subject Matter and Style, as well as bold Known Artists, Subject Matter and Style
    body2: "<b>Who:</b><br>El Lissitzky, Kazimir Malevich, Liubov Popova, and Aleksandr Rodchenko.<br><b>Subject Matter:</b><br>Completely non-representational.<br><b>Style:</b><br>The first system of purely abstract pictorial composition, based on geometric figures. Narrow range of colors.",
    //insert breaks
    caption: "Kazimir Malevich, <i>Supremus</i>, 1879–1935,<br>Oil paint on canvas,<br>803 × 800 mm,<br>Tate, London",
    image: "12.jpg"
}
...
var page10 = {
    ...
    //Need to insert breaks before Subject Matter and Style, as well as bold Known Artists, Subject Matter and Style
    body2: "<b>Who:</b><br>Piet Mondrian, Theo van Doesburg, Bart van der Leck, Georges Vantongerloo, and Gerrit Rietveld.<br><b>Subject Matter:</b><br>Non-objective.<br><b>Style:</b><br>Minimal abstract designs, straight lines, right angles, and primary colors (augmented by white, black and gray).",
    //insert breaks
    caption: "Piet Mondrian, <i>Composition B (No.II) with Red</i>, 1935,<br>Oil paint on canvas,<br>803 × 633 × 24 mm,<br>Tate, London",
    image: "05.jpg"
}
...
var page12 = {
    ...
    //Need to insert breaks before Subject Matter and Style, as well as bold Known Artists, Subject Matter and Style
    body2: "<b>Who:</b><br>Walter Gropius, Josef Albers, Theo van Doesburg, Lyonel Feininger, Wassily Kandinsky, Paul Klee, El Lissitzky, László Moholy-Nagy, and Ludwig Mies van der Rohe.<br><b>Subject Matter:</b><br>Designs for architecture, furniture, typography, functional ceramics, tapestries, etc.<br><b>Style:</b><br>The Bauhaus is really an institution, not a style. Although the Bauhaus designers initially concentrated on hand-crafted objects, they soon embraced industrial technology.",
    //insert breaks
    caption: "Lucia Moholy, Bauhaus Building, Dessau, 1925–6,<br>Photograph, gelatin silver print on paper,<br>Tate, London",
    image:"04.jpg"
}
...
var page14 = {
    ...
    //Need to insert breaks before Subject Matter and Style, as well as bold Known Artists, Subject Matter and Style
    body2: "<b>Who:</b><br>Thomas Hart Benton, Edward Hopper, Yasuo Kuniyoshi, Reginald Marsh, Grant Wood, and Andrew Wyeth.<br><b>Subject Matter:</b><br>Scenes from American history or contemporary America, portraits, landscapes, etc. Social Realists concentrated on urban, city scenes.<br><b>Style:</b><br>Realistic.",
    //insert breaks
    caption: "Edward Hopper, <i>Morning Sun</i>, 1952,<br>Oil on canvas,<br>28 1/8 x 40 1/8″,<br>Columbus Museum of Art, Columbus, Ohio",
    image: "10.jpg"
}
...
var page15 ={
    ...
    //Need to insert breaks before Subject Matter and Style, as well as bold Known Artists, Subject Matter and Style
    body2: "<b>Who:</b><br>Berenice Abbott, Ansel Adams, Eugène Atget, Bill Brandt, Brassaï, Henri Cartier-Bresson, Imogen Cunningham, Alfred Eisenstaedt, Walker Evans, André Kertész, Dorothea Lange, Albert Renger-Patzsch, August Sander, Edward Steichen,and Alfred Stieglitz.<br><b>Subject Matter:</b><br>Usually identifiable, representational subjects: portraits, landscapes, still lifes, etc.<br><b>Style:</b><br>Straight photography looks so familiar it is easy to forget that it is a conscious style. Usually, Straight Photographers produce black-and-white pictures. This style is often employed in Photojournalism and Documentary Photography.",
    //insert breaks
    caption: "Ansel Adams, <i>Moonrise</i>, Hernandez, New Mexico, 1941,<br>Gelatin silver print,<br>15 3/4 × 19 1/2 inch (40 × 49.5 cm),<br>Museum of Modern Art, NYC",
    image: "06.jpg"
}
